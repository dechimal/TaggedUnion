#if !defined DESALT_TAGGED_UNION_RECURSION_HPP_
#define      DESALT_TAGGED_UNION_RECURSION_HPP_
...
struct substitute_recursion_placeholder<std::array<T, N>, Subst>
    : detail::id<std::array<typename Subst<T>::type, N>>
{};
...
struct substitute_recursion_placeholder<Tmpl<Args...>, Subst>
    : detail::id<Tmpl<typename Subst<Args>::type...>>
{};

template<template<typename ...> class Tmpl, typename ...Args, template<typename> class Subst>
struct substitute_recursion_placeholder<Tmpl<type_fun, Args...>, Subst>
    : detail::id<typename Tmpl<type_fun, typename Subst<Args>::type...>::type>
{};

} // namespace traits {

using detail::rec_guard;
using detail::start_new_rec;
using detail::rec;
using _ = rec<0>;
